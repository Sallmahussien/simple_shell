...
int handle_exit_err (char **arr, char **argv, char *lineptr, node *env_list, char **sequences, int *exec);

int is_exit(char **arr, char *lineptr, char **argv, int *exec, node *env_list, char **sequences);
